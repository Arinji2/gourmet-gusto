...
export default async function SearchPage({
  ...
  return (
    <div className="flex h-fit min-h-[100svh] w-full flex-col items-center justify-start bg-black">
      ...
      <div className="hide-scrollbar z-20 mr-5 mt-10 flex h-full w-full flex-row items-center justify-start gap-10 overflow-x-auto overflow-y-hidden md:justify-evenly">
